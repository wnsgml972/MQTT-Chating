...
/*				for(int i=0; i<MainFrame.topicVector.size(); i++){
					if(text.equals(MainFrame.topicVector.get(i))){
						titleLabel.setText("이미 이름이 같은 방이 있습니다.");
						return;
					}
				}
				MainFrame.topicVector.add(text);*/
